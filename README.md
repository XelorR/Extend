...
- My full config with [all other layers](myLayout.jpg), including [Extend](kanata.kbd#L73-L81), [Kanata](https://github.com/jtroo/kanata) (use [this](Split.png) key arrangement on ergo split keyboard)
