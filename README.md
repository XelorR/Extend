...
- My full config [all other layers](myLayout.jpg), including [Extend](kanata.kbd#L61-L69), [Kanata](https://github.com/jtroo/kanata) (use [this](Split.png) key arrangement on ergo split keyboard)
