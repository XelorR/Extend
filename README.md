...
- My full config with [all other layers](36.kbd), including Extend, [Kanata](https://github.com/jtroo/kanata) (use [this](36.kbd#L8-L11) key arrangement on ergo split keyboard, this exact keys will be ramapped)
